...
public class WakeWordListener {
    ...
    public WakeWordListener(Context context, Runnable onWakeWordDetected, Runnable onError) {
        try {
            ...
            Log.e("WakeWord", "Activation limit exceeded. Please check your Picovoice console.");
            Toast.makeText(context, "Wake word activation limit exceeded", Toast.LENGTH_LONG).show();
